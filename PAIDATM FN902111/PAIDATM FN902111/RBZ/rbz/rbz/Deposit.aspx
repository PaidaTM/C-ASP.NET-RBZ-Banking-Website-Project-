            ...
            <div class="caption">
                ...
                <div class="main-button scroll-to-section">
                   ...
                   <tr><td><h5>Current Balance</h5></td>
                     ...
                     <tr><td>  <h5>Deposit Amount</h5> </td><td>&nbsp; &nbsp;<asp:TextBox ID="TextBox1" runat="server" font-size="X-Large" Font-Bold="true" BackColor="Transparent" BorderColor="#666666"  BorderStyle="Double" BorderWidth="5px" ForeColor="#ED563B" Height="40px" Width="150px"></asp:TextBox>
                         </td>  </tr>
                  </table> <div>
                  ...
                  <br />
                      ...
                      <asp:Button ID="Button1" class='btn' runat="server" Width="230px" Text="Deposit" OnClick="Button1_Click" Height="100%" BackColor="#ED563B" BorderColor="#FF6600" BorderStyle="Outset"  font-size="Medium" ForeColor="White" /></div>
                    </div>
                </div>
            </div>
        </div>
