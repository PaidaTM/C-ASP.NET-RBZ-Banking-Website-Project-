...
public partial class Withdraw : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql2 = string.Format(@"insert into finance values('{0}','{1}','{2}','{3}');",
           Label1.Text, " ", TextBox1.Text, "Withdraw");
        ...
        else
        {
            ...
            {
                Response.Write("<script>alert('Amount Deducted');</script>");

            }
            

        }
        Response.Write("<script>alert('Withdraw Successful!');window.location.href='Transaction.aspx';</script>");
    }
