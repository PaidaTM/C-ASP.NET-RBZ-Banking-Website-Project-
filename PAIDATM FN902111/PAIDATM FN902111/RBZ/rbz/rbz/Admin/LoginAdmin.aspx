        ...
        <div class="video-overlay header-text">
            ...
            <div class="form-box">
                <div class='button-box'>
                    <div id='btn'></div>
                    <button type='button'onclick='login()'class='toggle-btn'>Admin_LogIn</button>
                   
                </div>
                <form id='login' class='input-group-login'>
                    
            <asp:TextBox ID="TextBox1" class='input-field'  placeholder ='User_Name' runat="server"></asp:TextBox> 
		    <asp:TextBox ID="TextBox2"  class='input-field'  placeholder ='Password' runat="server" TextMode="Password"></asp:TextBox>
